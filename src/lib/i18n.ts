...
export const STRINGS: Record<Lang, Dict> = {
  id: {
    ...
    hero_title: "Kenyamanan kecil untuk hari-hari kamu.",
    hero_subtitle:
      "Baby Mo membuat jurnal emosional, mood stickers, dan barang-barang lembut yang dirancang untuk membuat hari kamu sedikit lebih hangat.",
    hero_cta_shop: "Belanja koleksi",
    hero_cta_best: "Lihat terlaris",
    hero_trust_orders: "🌷 12.000+ pesanan",
    hero_trust_rating: "💌 rating 4,9",
    hero_trust_packing: "📦 packing hari sama",
    hero_quote: "Rasanya seperti pelukan, dalam bentuk jurnal.",
    hero_quote_author: "— Naya, 23, Bandung",

    section_featured_eyebrow: "pilihan",
    section_featured_title: "Sesuatu yang lembut.",
    section_featured_subtitle:
      "Produk-produk yang sedang lembut kami sukai musim ini.",
    section_categories_eyebrow: "kategori",
    section_categories_title: "Kenyamanan untuk harimu",
    section_categories_subtitle:
      "Temukan hal kecil yang cocok dengan mood-mu hari ini.",
    section_bestsellers_eyebrow: "terlaris",
    section_bestsellers_title:
      "Yang paling sering dipilih komunitas kami.",
    section_testimonials_eyebrow: "kata mereka",
    section_testimonials_title:
      "Dari orang-orang yang butuh hari sedikit lebih lembut.",
    section_ig_eyebrow: "@babymo.id",
    section_ig_title: "Momen lembut, dari komunitas kami.",
    section_ig_cta: "Ikuti kami →",
    section_faq_eyebrow: "pertanyaan umum",
    section_faq_title: "Jawaban lembut untuk pertanyaanmu.",
    section_related_eyebrow: "kamu mungkin suka juga",
    section_related_title: "Dalam dunia lembut yang sama.",
    see_all: "Lihat semua →",

    product_search_placeholder: "Cari jurnal, stiker, lilin...",
    product_filter_all: "Semua",
    product_listing_title: "Hal-hal lembut, semua di satu tempat.",
    product_listing_subtitle:
      "Jelajahi produk yang dipilih dengan hati — untuk membuat harimu sedikit lebih nyaman.",
    product_bestseller_title: "Yang paling dicintai komunitas.",
    product_bestseller_active: "Menampilkan terlaris ·",
    product_clear: "hapus",
  ...
  en: {
    ...
    hero_title: "Small comforts for your everyday moments.",
    hero_subtitle:
      "Baby Mo creates emotional journals, mood stickers, and cozy little things — designed to soften your days and hold your softest thoughts.",
    hero_cta_shop: "Shop the collection",
    hero_cta_best: "See bestsellers",
    hero_trust_orders: "🌷 12,000+ orders",
    hero_trust_rating: "💌 4.9 average rating",
    hero_trust_packing: "📦 Same-day packing",
    hero_quote: "It feels like a hug, in journal form.",
    hero_quote_author: "— Naya, 23, Bandung",

    section_featured_eyebrow: "featured",
    section_featured_title: "A little something soft.",
    section_featured_subtitle:
      "Pieces our team is gently obsessed with this season.",
    section_categories_eyebrow: "categories",
    section_categories_title: "Comfort for your day",
    section_categories_subtitle:
      "Find the little thing that fits your mood today.",
    section_bestsellers_eyebrow: "bestsellers",
    section_bestsellers_title:
      "What our community keeps reaching for.",
    section_testimonials_eyebrow: "kind words",
    section_testimonials_title:
      "From people who needed a little softer day.",
    section_ig_eyebrow: "@babymo.id",
    section_ig_title: "Soft moments, from our community.",
    section_ig_cta: "Follow us →",
    section_faq_eyebrow: "frequently asked",
    section_faq_title: "Soft answers to your questions.",
    section_related_eyebrow: "you might also love",
    section_related_title: "In the same gentle world.",
    see_all: "See all →",

    product_search_placeholder: "Search journals, stickers, candles…",
    product_filter_all: "All",
    product_listing_title: "Soft little things, all in one place.",
    product_listing_subtitle:
      "Browse carefully chosen products — designed to make your every day a little more comforting.",
    product_bestseller_title: "What our community loves most.",
    product_bestseller_active: "Showing bestsellers ·",
    product_clear: "clear",
